...
#DA_microbe_abundances <- read.csv("results/docs/DA_microbe_abundances_phyclr.csv", row.names = 1)
DA_microbe_abundances <- read.csv("results/docs/DA_microbe_abundances_relativeabun.csv", row.names = 1)
...
ggplot(aldex2_clr_all_sig, aes(x=DA_urbanism)) +
  ...
  ggtitle("Differentially abundant microbes (n=178)")
```
Effect sizes
```{r}
