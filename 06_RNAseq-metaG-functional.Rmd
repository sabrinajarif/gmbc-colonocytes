...
```{r}
#gene_families <- read.csv("data/metaG-functional/genefam_combined.tsv", header =T, sep = "\t")
...
```
This is a lot of data...lets start at the pathway level instead.
...
```{bash}
scp -r data/for_hpc/*.rds sjarif@midway3-login4.rcc.uchicago.edu:/project/blekhman/sjarif/GMbC/DESeq
```
